...
public class BedRoomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        time_light = (TextView) findViewById(R.id.time_light_bed);
        time_fan = (TextView) findViewById(R.id.time_fan_bed);
        time_air = (TextView) findViewById(R.id.time_air_bed);

        // Create view
        TextView temp = findViewById(R.id.txt_bed_temp);
        TextView hum = findViewById(R.id.txt_bed_hum);
        switch_fan = findViewById(R.id.fan_bed_switch);
        switch_light = findViewById(R.id.light_bed_switch);
        switch_air = findViewById(R.id.air_bed_switch);

        ImageView clock_fan = findViewById(R.id.clock_fan_bed);
        ImageView clock_light = findViewById(R.id.clock_light_bed);
        ImageView clock_air = findViewById(R.id.clock_air_bed);
        ...
        fan_img = (ImageView) findViewById(R.id.fan_bed);
        air_img = (ImageView) findViewById(R.id.air_bed);
        light_img = (ImageView) findViewById(R.id.light_bed);
        ImageView back = (ImageView) findViewById(R.id.bed_back);
