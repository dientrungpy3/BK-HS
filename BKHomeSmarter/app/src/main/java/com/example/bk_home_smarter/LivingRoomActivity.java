...
public class LivingRoomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        time_light = (TextView) findViewById(R.id.time_light_liv);
        time_fan = (TextView) findViewById(R.id.time_fan_liv);
        time_air = (TextView) findViewById(R.id.time_air_liv);

        // Create view
        TextView temp = findViewById(R.id.txt_liv_temp);
        TextView hum = findViewById(R.id.txt_liv_hum);
        switch_fan = findViewById(R.id.fan_liv_switch);
        switch_light = findViewById(R.id.light_liv_switch);
        switch_air = findViewById(R.id.air_liv_switch);

        ImageView clock_fan = findViewById(R.id.clock_fan_liv);
        ImageView clock_light = findViewById(R.id.clock_light_liv);
        ImageView clock_air = findViewById(R.id.clock_air_liv);
        ...
        fan_img = (ImageView) findViewById(R.id.fan_liv);
        air_img = (ImageView) findViewById(R.id.air_liv);
        light_img = (ImageView) findViewById(R.id.light_liv);
