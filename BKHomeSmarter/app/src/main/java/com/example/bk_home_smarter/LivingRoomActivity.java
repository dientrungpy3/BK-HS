...
;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Switch switch_fan = findViewById(R.id.fan_liv_switch);
        Switch switch_light = findViewById(R.id.light_liv_switch);
        Switch switch_air = findViewById(R.id.air_liv_switch);
