...
public class BathRoomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        time_light = (TextView) findViewById(R.id.time_light_bath);
        time_fan = (TextView) findViewById(R.id.time_fan_bath);
        time_air = (TextView) findViewById(R.id.time_air_bath);

        // Create view
        TextView temp = findViewById(R.id.txt_bath_temp);
        TextView hum = findViewById(R.id.txt_bath_hum);
        switch_fan = findViewById(R.id.fan_bath_switch);
        switch_light = findViewById(R.id.light_bath_switch);
        switch_air = findViewById(R.id.air_bath_switch);

        ImageView clock_fan = findViewById(R.id.clock_fan_bath);
        ImageView clock_light = findViewById(R.id.clock_light_bath);
        ImageView clock_air = findViewById(R.id.clock_air_bath);
        ...
        fan_img = (ImageView) findViewById(R.id.fan_bath);
        air_img = (ImageView) findViewById(R.id.air_bath);
        light_img = (ImageView) findViewById(R.id.light_bath);
        ImageView back = (ImageView) findViewById(R.id.bath_back);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BathRoomActivity.this, HomeActivity.class);
...
//                Toast.makeText(getApplicationContext(), last_temp, Toast.LENGTH_SHORT).show();
        ...
        mqttService.setCallback(new MqttCallbackExtended() {
            ...
            public void messageArrived(String topic, MqttMessage message) throws Exception {
                ...
                to get temp and humid from CSE_BBC
    ...
    private void setCountDown(String device, int hour, int minute, int second) {
        ...
        if (device.equals("fan")){
            ...
            cTimer_light = new CountDownTimer(time_delta, 1000) {
                ...
                public void onFinish() {
                    switch_light_state = (switch_light_state == false) ? true : false;
                    switch_light.setChecked(switch_light_state);
                    if (switch_light_state) {
                        light_img.setImageResource(R.drawable.light_on);
                        light.data = "1";
