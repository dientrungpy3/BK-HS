...
public class BathRoomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Switch switch_fan = findViewById(R.id.fan_bath_switch);
        Switch switch_light = findViewById(R.id.light_bath_switch);
        Switch switch_air = findViewById(R.id.air_bath_switch);
        boolean switch_fan_state = false;
        boolean switch_light_state = false;
        boolean switch_air_state = false;

        ImageView fan_img = (ImageView) findViewById(R.id.fan_bath);
        ImageView air_img = (ImageView) findViewById(R.id.air_bath);
        ImageView light_img = (ImageView) findViewById(R.id.light_bath);
