...
public class DiningRoomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        time_light = (TextView) findViewById(R.id.time_light_dining);
        time_fan = (TextView) findViewById(R.id.time_fan_dining);
        time_air = (TextView) findViewById(R.id.time_air_dining);

        // Create view
        TextView temp = findViewById(R.id.txt_dining_temp);
        TextView hum = findViewById(R.id.txt_dining_hum);
        switch_fan = findViewById(R.id.fan_dining_switch);
        switch_light = findViewById(R.id.light_dining_switch);
        switch_air = findViewById(R.id.air_dining_switch);

        ImageView clock_fan = findViewById(R.id.clock_fan_dining);
        ImageView clock_light = findViewById(R.id.clock_light_dining);
        ImageView clock_air = findViewById(R.id.clock_air_dining);
        ...
        fan_img = (ImageView) findViewById(R.id.fan_dining);
        air_img = (ImageView) findViewById(R.id.air_dining);
        light_img = (ImageView) findViewById(R.id.light_dining);
        ImageView back = (ImageView) findViewById(R.id.dining_back);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DiningRoomActivity.this, HomeActivity.class);
